const healthyFoods = [
  ...
  },
  {
    ...
    description:
      "Ensalada fresca con tomates, pepinos, aceitunas y queso feta.",
    keyIngredients: [
      "Tomates",
      "Pepinos",
      "Aceitunas",
  ...
  },
  {
    ...
    description:
      "Pechuga de pollo marinada con limón, ajo y hierbas, luego asada.",
  ...
  },
  {
    ...
    description:
      "Pizza con base de coliflor, tomate, queso mozzarella y albahaca.",
    keyIngredients: [
      "Coliflor",
      "Tomate",
      "Mozzarella",
...
function showRandomFoods() {
  const shuffledFoods = [...healthyFoods]
